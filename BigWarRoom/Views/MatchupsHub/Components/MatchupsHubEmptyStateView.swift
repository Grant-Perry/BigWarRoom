//
//  MatchupsHubEmptyStateView.swift
//  BigWarRoom
//
//  Animated empty state view for MatchupsHubView
//

import SwiftUI

struct MatchupsHubEmptyStateView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            CTAButtonSection(onSettingsTap: onSettingsTap)
...
private struct HeroAnimationSection: View {
    var body: some View {
        ZStack {
...
private struct InnerEnergyRing: View {
    var body: some View {
        Circle()
            .stroke(
                LinearGradient(
...
private struct CentralGradientBackground: View {
    var body: some View {
        Circle()
            .fill(
                RadialGradient(
...
private struct FootballIcon: View {
    var body: some View {
...
private struct DramaticTextSection: View {
    var body: some View {
        VStack(spacing: 16) {
...
private struct CTAButtonSection: View {
    let onSettingsTap: () -> Void
    var body: some View {
        VStack(spacing: 20) {
            ZStack {
                FloatingParticles()
                MainCtaButton(onTap: onSettingsTap)
            }
            .frame(height: 80)
...
private struct MainCtaButton: View {
    let onTap: () -> Void
    var body: some View {
        Button(action: onTap) {
            HStack(spacing: 12) {
...
private struct AnimatedBackgroundParticles: View {
    var body: some View {
        ZStack {
