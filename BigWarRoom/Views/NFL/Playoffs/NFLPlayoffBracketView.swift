   ...
   private func bracketContent(_ bracket: PlayoffBracket) -> some View {
	  ...
	  ScrollView([.horizontal, .vertical], showsIndicators: false) {
		 VStack(spacing: 0) { // Using a safe space value to prevent crash
							  // Title - CENTERED with dynamic year (no comma formatting) - 🔥 INCREASED TOP PADDING
			VStack(spacing: 2) {
			...
			.padding(.top, 48)  // 🔥 INCREASED: More breathing room from picker (was 24)
			...
			.cornerRadius(8)	   // Notice to turn sideways
